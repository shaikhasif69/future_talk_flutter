...
mixin _$ApiError {
  ...
  bool get isUnauthorized => throw _privateConstructorUsedError;
...
class _$ApiErrorImpl implements _ApiError {
  ...
  @override
  String toString() {
    return 'ApiError(message: $message, statusCode: $statusCode, details: $details, isNetwork: $isNetwork, isTimeout: $isTimeout, isUnauthorized: $isUnauthorized)';
  }
