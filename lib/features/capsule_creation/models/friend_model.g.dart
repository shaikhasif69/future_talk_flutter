...
_$FriendImpl _$$FriendImplFromJson(Map<String, dynamic> json) => _$FriendImpl(
      ...
      socialBattery:
          $enumDecode(_$SocialBatteryLevelEnumMap, json['socialBattery']),
      lastActive: DateTime.parse(json['lastActive'] as String),
      username: json['username'] as String?,
      isOnline: json['isOnline'] as bool? ?? false,
      communicationPreference: $enumDecodeNullable(
...
Map<String, dynamic> _$$FriendImplToJson(_$FriendImpl instance) =>
    <String, dynamic>{
      ...
      'communicationPreference': _$FriendCommunicationPreferenceEnumMap[
          instance.communicationPreference]!,
