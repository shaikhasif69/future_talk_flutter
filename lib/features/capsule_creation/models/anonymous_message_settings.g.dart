...
_$AnonymousMessageSettingsImpl _$$AnonymousMessageSettingsImplFromJson(
  ...
  identityRevealOption:
      $enumDecodeNullable(
        _$IdentityRevealOptionEnumMap,
        json['identityRevealOption'],
      ) ??
  ...
  deliveryMethod:
      $enumDecodeNullable(
        _$AnonymousDeliveryMethodEnumMap,
        json['deliveryMethod'],
      ) ??
...
Map<String, dynamic> _$$AnonymousMessageSettingsImplToJson(
  ...
  'deliveryMethod': _$AnonymousDeliveryMethodEnumMap[instance.deliveryMethod]!,
};
