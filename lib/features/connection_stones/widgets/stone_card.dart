            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _isHovered 
                        ? widget.stone.stoneType.primaryColor.withAlpha(51)
              ...
              child: StoneTouchDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _isHovered 
                          ? widget.stone.stoneType.primaryColor.withAlpha(77)
                          : Colors.transparent,
                      width: 2,
                    ),
                  ),
        ...
        children: [
          ...
          Text(
            ...
            .shimmer(
              ...
              color: widget.stone.stoneType.primaryColor.withAlpha(77),
            ),
        ],
      );
    }
...
class StoneDetailsModal extends ConsumerWidget {
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: stone.stoneType.primaryColor.withAlpha(26),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: stone.stoneType.primaryColor.withAlpha(77),
            ),
          ),
          child: Text(
  ...
  Widget _buildStoneInfo() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: stone.stoneType.primaryColor.withAlpha(13),
        borderRadius: BorderRadius.circular(12),
      ),
      child: Column(
        children: [
