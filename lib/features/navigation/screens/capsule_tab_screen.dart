...
/// Capsule tab placeholder screen
/// Temporary implementation until actual time capsule feature is developed
class CapsuleTabScreen extends ConsumerWidget {
  const CapsuleTabScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeatureCard(
              ...
              description: 'Send messages to be opened later',
            ...
            _buildFeatureCard(
              ...
              description: 'Preserve thoughts and memories',
